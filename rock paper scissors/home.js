function rpsGame(yourChoice){
    ...
    results = gameWinner(humanChoice,botChoice);
    console.log(results);
...
function gameWinner(yourChoice,computerChoice){
    var rpsDatabase = {
...
function finalMessage([yourScore,computerScore]){
    if(yourScore === 0) {
        ...
        return {'message':'Draw','color':'darkorange'};
    }
    else {
...
function rpsFrontEnd(humanImageChoice,botImageChoice,finalMessage){
    ...
    humanDiv.innerHTML = "<img = src='"+ imageDatabase[humanImageChoice]+ "'width=150px height=190px>";

    messageDiv.innerHTML = "<h1 style='color: "+ finalMessage['color']+"; font-size = 60px; padding=20px;'>" + finalMessage['message'] +"</h1"

    botDiv.innerHTML = "<img = src='"+ imageDatabase[botImageChoice]+ "'width=150px height=190px>";
